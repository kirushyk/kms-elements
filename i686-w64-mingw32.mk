...
WEBRTCENDPOINT_TARGET=libwebrtcendpoint.dll
...
RECORDERENDPOINT_TARGET=librecorderendpoint.dll

RECORDERENDPOINT_SRC= \
./src/gst-plugins/recorderendpoint/kmsbasemediamuxer.c \
./src/gst-plugins/recorderendpoint/kmsavmuxer.c \
...
WEBRTCENDPOINT_OBJS=$(WEBRTCENDPOINT_SRC:.c=.o)
RECORDERENDPOINT_OBJS=$(RECORDERENDPOINT_SRC:.c=.o)
...
$(TARGET_DIR)/$(WEBRTCENDPOINT_TARGET) \
$(TARGET_DIR)/$(RECORDERENDPOINT_TARGET) \
...
$(TARGET_DIR)/$(WEBRTCENDPOINT_TARGET): $(WEBRTCENDPOINT_OBJS)
	mkdir -p $(TARGET_DIR)
	$(CC) -shared -o $@ $(CFLAGS) $^ $(LIBS) $(WEBRTCENDPOINT_LIBS)

$(TARGET_DIR)/$(RECORDERENDPOINT_TARGET): $(RECORDERENDPOINT_OBJS)
	mkdir -p $(TARGET_DIR)
	$(CC) -shared -o $@ $(CFLAGS) $^ $(LIBS) $(RECORDERENDPOINT_LIBS)
...
clean:
	...
	rm -f $(RTCPDEMUX_OBJS)
	rm -f $(TARGET_DIR)/$(RTCPDEMUX_TARGET)
	rm -f $(WEBRTCENDPOINT_OBJS)
	rm -f $(TARGET_DIR)/$(WEBRTCENDPOINT_TARGET)
	rm -f $(RECORDERENDPOINT_OBJS)
	rm -f $(TARGET_DIR)/$(RECORDERENDPOINT_TARGET)
